...
class LocalStorageApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: LocalStorageApi?) {
    let addFaveChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.candy_store.LocalStorageApi.addFave", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removeFaveChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.candy_store.LocalStorageApi.removeFave", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isFaveChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.candy_store.LocalStorageApi.isFave", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getFavesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.candy_store.LocalStorageApi.getFaves", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
